//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//SCENE02 - CORRESPONENT AL NIVELL 02
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
class Scene03 extends Phaser.Scene {
    ...
    init(data){
        console.log('Carregant correctament el Nivell 2');
        this.punts = data && data.punts ? data.punts : 0;
    }
    ...
    create(){
        ...
        //PLATAFORMA04// 
        this.plataforma04 = this.physics.add.staticGroup();
        this.plataforma04.create(200, 430, 'plataforma04').setScale(2);
        this.plataforma04.create(700, 420, 'plataforma04').setScale(2); 
        this.plataforma04.create(1250, 420, 'plataforma04').setScale(2); 
        this.plataforma04.create(1750, 430, 'plataforma04').setScale(2); 

        //Tamany del collider de la Plataforma04 i la seva configuració
        var plataforma04ColliderWidth = 440;
        var plataforma04ColliderHeight = 100;
        const plataforma04ColliderOffsetX = -55;
        const plataforma04ColliderOffsetY = 15;

        //Aquest codi aplica el tamany dels colliders a totes les plataformes04
        this.plataforma04.children.iterate(plataforma => {
        plataforma.setSize(plataforma04ColliderWidth, plataforma04ColliderHeight);
        plataforma.setOffset(plataforma04ColliderOffsetX, plataforma04ColliderOffsetY);
        ...
        this.physics.add.collider(this.player, this.plataforma04,);
        ...
        var drone = this.drone = this.physics.add.image(1000, 250, 'drone').setScale(1.3);
        ...
        //Creació dels Power Ups 
        this.powerUp = this.physics.add.group();
        //PowerUps col·locats al llarg del nivell
        this.powerUp.create(250, 300, 'powerUp');//1
        this.powerUp.create(500, 200, 'powerUp');//2
        this.powerUp.create(1000, 250, 'powerUp');//3
        this.powerUp.create(1400, 300, 'powerUp');//4
        this.powerUp.create(1600, 250, 'powerUp');//5
        ...
        let zonaFinal = this.finalNivell.create(2000,290, 'moto').setScale(2,2);        
