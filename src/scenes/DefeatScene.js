...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Escena de la pantalla de derrota: Es presionarà enter per carregar el primer nivell
...
class DefeatScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Elements del menú
          ...
          this.bg_3 = this.add.image(0,300, 'defeatBg');
          this.bg_3.setScale(3.2,3.2);
        
        // Text del joc
         this.titolText = this.add.image(50,130, 'defeatText').setOrigin(0);
